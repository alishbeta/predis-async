 ...
 * @method PromiseInterface|mixed  eval($script, $numkeys, $keyOrArg1 = null, $keyOrArgN = null)
 * @method PromiseInterface|mixed  evalsha($script, $numkeys, $keyOrArg1 = null, $keyOrArgN = null)
